...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_DEL , KC_QUOT, KC_COMM, KC_DOT , KC_P   , KC_Y   ,                      _______, _______, _______, _______, _______, _______,
        KC_BSPC, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   ,                      _______, _______, _______, _______, _______, _______,
        S(KC_1), KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   ,                      _______, _______, _______, _______, _______, _______,
